...
function AppContent() {
  ...
  const [userLocation, setUserLocation] = useState({ lat: 47.6062, lng: -122.3321 }); // Seattle default
        ...
        <View className="bg-surface/80 px-6 py-4 border-b border-outline-variant/10 flex-row justify-between items-center h-16">
          <View className="flex-row items-center gap-3">
            <TouchableOpacity 
              ...
              className="p-2 rounded-full bg-primary/5 transition-colors"
            >
            ...
            <View>
              ...
              <View className="flex-row items-center gap-2">
                ...
                {(locationName.includes('Denied') || locationName.includes('Timeout') || locationName.includes('Unavailable')) && (
                  <TouchableOpacity 
                    onPress={() => setIsLocationModalOpen(true)}
                  >
          ...
          >
            <View className="flex-row justify-between items-start mb-4">
              <View className="flex-1 pr-4">
                ...
                <Text className="text-sm text-on-surface-variant">Tap on the map or enter coordinates.</Text>
              </View>
              <TouchableOpacity 
                onPress={async () => {
                  try {
            ...
            <View className="flex-row items-center bg-surface-container-low rounded-xl border border-outline-variant/30 px-3 mb-4">
              ...
              <TextInput
                ...
                className="flex-1 p-3 text-on-surface text-sm outline-none"
              />
              <TouchableOpacity 
            ...
            <View className="h-64 mb-6 rounded-2xl overflow-hidden border border-outline-variant/30">
              <MapPicker 
            ...
            <View className="flex-row gap-3">
              ...
              <TouchableOpacity 
                ...
                className={`flex-2 py-4 rounded-2xl items-center justify-center shadow-md ${isConfirming ? 'bg-primary/50' : 'bg-primary'}`}
              >
